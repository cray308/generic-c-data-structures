...
/**
 * Creates a new set as a copy of an existing USet.
 *
 * @param   id     ID used with gen_uset.
...
/**
 * Removes a single element from the set which is equal to `value`, if it exists.
 *
 * @param  id     ID used with gen_uset.
 * @param  s      Pointer to set.
...
/**
 * Modifies the number of buckets in the set. If this is less than or equal to the current number
 ...
 *   value, and may rehash the set if required.
 *
 * @param  id  ID used with gen_uset.
 * @param  s   Pointer to set.
...
/**
 * Generates unordered set code for the given value type.
 *
